...
return new class extends Migration
{
    ...
    public function up(): void 
    {
        ...
        Schema::create('pedido_itens', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pedido_id')->constrained('pedidos')->onDelete('cascade');//relacionamento com pedido
            ...
            $table->decimal('preco_unitario', 10, 2);//total (qtd * p_unitario)
            $table->timestamps();//rel prato e bebida
        });
    }
     ...
     */
    public function down(): void// remoção de tabelas, c1 itens com chave estrangeira, c2 pedidos
    {

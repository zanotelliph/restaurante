...
return new class extends Migration
{
    ...
    {
        Schema::table('pratos', function (Blueprint $table) {//adiciona coluna estoque
            $table->integer('estoque')->default(0)->after('disponivel');//controle
        });
     ...
     */
    public function down(): void// remove
    {

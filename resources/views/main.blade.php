...
<head>
    ...
    <title>Into BigHouse</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        :root {
            --primary-color: #0066CC;
            --secondary-color: #083769;
            --dark-color: #1a1a1a;
            --light-blue: #E6F0FF;
        }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('dashboard') }}">🍽️ BigHouse</a>
    ...
    <footer>
        <div class="container text-center">
            <p>&copy; 20 de julho, CEP 234567 - 2026 Into BigHouse - Horário de Funcionamento: 11h00 às 23
                h00 . </p>
        </div>
    </footer>
